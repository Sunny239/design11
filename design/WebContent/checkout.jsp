		...
		<%
			...
			<%}else{
				...
				<% while(i.hasNext()){
					...
					<tr>
						<td><input type="checkbox" name="cartcheckbox" value="<%=ci.getProduct().getId()%>" onclick="selectSingle()"></td>
						<td class="ring-in">
				...
				%> 
				<tr><td><input id="allCheckBox" type="checkbox" value="" onclick="selectAll()" />全选&nbsp;&nbsp;&nbsp;&nbsp;<a href="${ctx }/cart/delall"><font color="gray">删除</font></a></td>
					<td colspan="3"></td>					
					<%
