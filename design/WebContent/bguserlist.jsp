  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${list.address }</td>
        <td align="center" valign="middle" class="borderright borderbottom">普通用户</td>
        <td align="center" valign="middle" class="borderright borderbottom">已激活</td>
        <td align="center" valign="middle" class="borderright borderbottom">${list.date }</td>
        <td align="center" valign="middle" class="borderbottom"><span class="gray"></span><a href="${ctx }/admin/deluser?address=${list.address }" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
      <%count++; %>
      </c:forEach>
    </table></td>
